...
export const SuperScriptIcon = ({ className = "" }: { className?: string }) => {
  return (
    <svg className={className} width="21" height="21">
      <path
...
export const SubScriptIcon = ({ className = "" }: { className?: string }) => {
  return (
    <svg className={className} width="21" height="21">
      <path
...
export const QuoteIcon = ({ className = "" }: { className?: string }) => {
  return (
    <svg className={className} width="21" height="21" data-multipart="true">
